...
authnew:     file format elf32-i386
...
080484c0 <auth>:
 ...
 80484dc:	5d                   	pop    %ebp
 80484dd:	01 c1                	add    %eax,%ecx
 80484df:	01 c1                	add    %eax,%ecx
 80484e1:	c3                   	ret    
 80484e2:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%eax,%eax,1)
...
080484f0 <main>:
 ...
 804857b:	5d                   	pop    %ebp
 804857c:	01 c1                	add    %eax,%ecx
 804857e:	01 c1                	add    %eax,%ecx
 8048580:	c3                   	ret    
